...
System.out.println("In init() of Filter2");
}

@Override
public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
//before Part
System.out.println("In Before doFilter() of Filter2");
...
//After Part
System.out.println("In After doFilter() of Filter2");
//Modify response
...
@Override
public void destroy() {
System.out.println("In destroy() method of Filter2");
}
